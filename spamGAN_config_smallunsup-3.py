...
g_pretrain_epochs = 40# 40
d_pretrain_epochs = 5# 5
...
train_data = {
    ...
    'datasets' : [ 
        {
            "files" : ['/home/yankun/spamGAN/opSpamData/10/train_reviews.txt'],
        ...
        {
            'files' : '/home/yankun/spamGAN/opSpamData/10/train_labels.txt',
            'data_type' : 'int',
            'data_name' : 'label'
        }
    ]
