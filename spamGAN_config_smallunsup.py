...
clas_test_ckpt = '/home/yankun/spamGAN/output/ckpt-bestclas' # Which checkpoint to use for classifier testing
clas_pred_output = '/home/yankun/spamGAN/output/clas_pred_output.txt' # Where to save classifier test predictions
...
log_dir= '/home/yankun/spamGAN/output' # Where to store logs
checkpoint_dir= '/home/yankun/spamGAN/output' # Where to store ckpt files
load_checkpoint_file = None # Which checkpoint to load
clas_pretrain_save = True
...
g_pretrain_epochs = 40  #40# 60
d_pretrain_epochs = 5 #5# 60
d_pretrain_critic_epochs = 5 #10#20
c_pretrain_epochs =12 # 20
adversarial_epochs = 0 # How many total adversarial epochs, for all components
...
adv_gen_train_with_unsup = True # Whether or not to use unlabeled examples in adv
...
train_data = {
    ...
    'datasets' : [ 
        {
            "files" : ['/home/yankun/dividedData/labeled10/train_review.txt'],
            'vocab_file' : '/home/yankun/dividedData/vocab.txt',
            'max_seq_length' : 128,
        ...
        {
            'files' : '/home/yankun/dividedData/labeled10/train_label.txt',
            'data_type' : 'int',
            'data_name' : 'label'
        }
    ]
...
val_data = {
    ...
    'datasets' : [ 
        {
            "files" : ['/home/yankun/dividedData/labeled10/val_review.txt'],
            'vocab_file' : '/home/yankun/dividedData/vocab.txt',
            'max_seq_length' : 128,
            'length_filter_mode' : 'truncate',
            'bos_token' : '<BOS>',
        ...
        {
            'files' : ['/home/yankun/dividedData/labeled10/val_label.txt'],
            'data_type' : 'int',
            'data_name' : 'label'
        }
    ]
...
test_data = { 
    ...
    'datasets' : [ 
        {
            "files" : '/home/yankun/spamGAN_output/test_review.txt',
            'vocab_file' : '/home/yankun/dividedData/vocab.txt',
            'max_seq_length' : 128,
            'length_filter_mode' : 'truncate',
            'bos_token' : '<BOS>',
        ...
        {
            'files' : '/home/yankun/spamGAN_output/test_label.txt',
            'data_type' : 'int',
            'data_name' : 'label'
        }
    ]
